...
## Model
www.msaez.io/#/storming/73281a192df9aac63cd42a51c0756cca
...
- basic
```
 http :8088/employees id="id" userId="userId" departmentId="departmentId" rankId="rankId" employeeUser="employeeUser" 
